...
const Hor1: LetterComp = ({rectStyle}) => <rect x='0.75' y='0.75' width='8.5' height='0.5' rx='0.25' style={rectStyle}/>
const Hor2: LetterComp = ({rectStyle}) => <rect x='0.75' y='4.75' width='8.5' height='0.5' rx='0.25' style={rectStyle}/>
const Hor3: LetterComp = ({rectStyle}) => <rect x='0.75' y='8.75' width='8.5' height='0.5' rx='0.25' style={rectStyle}/>
const Ver1: LetterComp = ({rectStyle}) => <rect x='0.75' y='0.75' width='0.5' height='8.5' rx='0.25' style={rectStyle}/>
const Ver2: LetterComp = ({rectStyle}) => <rect x='4.75' y='0.75' width='0.5' height='8.5' rx='0.25' style={rectStyle}/>
const Ver3: LetterComp = ({rectStyle}) => <rect x='8.75' y='0.75' width='0.5' height='8.5' rx='0.25' style={rectStyle}/>
const Hor1b: LetterComp = ({rectStyle}) => <rect x='2.65' y='5.5' width='4.7' height='0.5' rx='0.25' style={rectStyle}/>
const Hor2b: LetterComp = ({rectStyle}) => <rect x='2.65' y='6.75' width='4.7' height='0.5' rx='0.25' style={rectStyle}/>
const Hor3b: LetterComp = ({rectStyle}) => <rect x='2.65' y='8.00' width='4.7' height='0.5' rx='0.25' style={rectStyle}/>
const Ver1b: LetterComp = ({rectStyle}) => <rect x='2.65' y='5.5' width='0.5' height='3.00' rx='0.25' style={rectStyle}/>
const Ver2b: LetterComp = ({rectStyle}) => <rect x='4.75' y='5.5' width='0.5' height='3.00' rx='0.25' style={rectStyle}/>
const Ver3b: LetterComp = ({rectStyle}) => <rect x='7.10' y='5.5' width='0.5' height='3.00' rx='0.25' style={rectStyle}/>
const Vt1: LetterComp = ({rectStyle}) => <rect x='-0.80' y='4.75' width='6' height='0.5' rx='0.25' transform-origin='center' transform='rotate(45)' style={rectStyle} />
const Vt2: LetterComp = ({rectStyle}) => <rect x='2.65' y='2.5' width='4.7' height='0.5' rx='0.25' style={rectStyle}/>
const Vt3: LetterComp = ({rectStyle}) => <rect x='-0.80' y='4.75' width='6' height='0.5' rx='0.25' transform-origin='center' transform='rotate(135)' style={rectStyle} />
const Vb1: LetterComp = ({rectStyle}) => <rect x='-0.80' y='4.75' width='6' height='0.5' rx='0.25' transform-origin='center' transform='rotate(-45)' style={rectStyle} />
const Vb2: LetterComp = ({rectStyle}) => <rect x='2.65' y='7' width='4.7' height='0.5' rx='0.25' style={rectStyle}/>
const Vb3: LetterComp = ({rectStyle}) => <rect x='-0.80' y='4.75' width='6' height='0.5' rx='0.25' transform-origin='center' transform='rotate(-135) 'style={rectStyle} />
